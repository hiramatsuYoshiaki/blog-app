...
const Admin = () => {
    ...
    return (
        <div　className={classes.root}>
            ...
            <Button color="primary">ロケーション</Button>
            <Button color="primary" onClick={() => dispatch(push('/stage/edit'))}>ステージ</Button>
            <Button color="primary"  onClick={() => dispatch(push('/tags/edit'))}>タグ</Button>
